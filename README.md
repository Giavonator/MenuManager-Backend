...
[ApplicationDesignFile.md](./design/concepts/ApplicationDesignFile.md)

## UserAuthorization Concept

1. [UserAuthentication.md](./design/concepts/UserAuthentication/UserAuthentication.md)
2. [DesignChanges.md](./design/concepts/UserAuthentication/DesignChanges.md)
3. [TestExecutionConsole.md](./design/concepts/UserAuthentication/TestExecutionConsole.md)
4. [UserAuthenticationConcept.ts](./src/concepts/UserAuthentication/UserAuthenticationConcept.ts)
5. [UserAuthenticationConcept.test.ts](./src/concepts/UserAuthentication/UserAuthenticationConcept.test.ts)
