...
content_id: 468e8d8bea397a3ff3873a0cba4273fc6b1fb6f582170858bfb7eb0eb675d5d8
---
  ...
  async _getIngredientsPerStore(
    ...
    for (const menuId of menuIds) {
      ...
      for (const itemId in menuIngredients) {
        // Fix: Cast itemId to Item type when indexing menuIngredients
        const { amount, units } = menuIngredients[itemId as Item];
