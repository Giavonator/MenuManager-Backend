---
timestamp: 'Wed Oct 15 2025 19:39:57 GMT-0400 (Eastern Daylight Time)'
parent: '[[../20251015_193957.24bc6597.md]]'
content_id: ae4f79e71722bbef43284f2f4afc20056437c826348a40f6958938d24bf53ab3
---
...
export default class MenuManagerConcept {
   ...
   */
  async updateMenuName(input: UpdateMenuNameInput): Promise<UpdateMenuNameOutput> {
   ...
   * @effects update the given attribute
   */
  async updateMenuDate(input: UpdateMenuDateInput): Promise<UpdateMenuDateOutput> {
   ...
   * @effects update the given attribute
   */
  async updateItemPrice(input: UpdateItemPriceInput): Promise<UpdateItemPriceOutput> {
   ...
   * @effects update the given attribute
   */
  async updateItemUnits(input: UpdateItemUnitsInput): Promise<UpdateItemUnitsOutput> {
   ...
   * @effects update the given attribute
   */
  async updateItemStore(input: UpdateItemStoreInput): Promise<UpdateItemStoreOutput> {
   ...
   */
  async _getListOfItems(input: GetListOfItemsInput = {}): Promise<GetListOfItemsOutput> {
   ...
   */
  async _getMenuByDate(input: GetMenuByDateInput): Promise<GetMenuByDateOutput> {
    const { date } = input;
