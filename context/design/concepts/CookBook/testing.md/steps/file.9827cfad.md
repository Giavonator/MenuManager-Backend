...
content_id: 9827cfada7128ade61de44a3aa4f12c80a19dc1e8c9c4dc3c847379f36bf7ba7
---
...
Deno.test("CookBookConcept - Operational Principle Verification", async (t) => {
  ...
  await t.step(
    ...
    async () => {
      ...
      assertAndLog(
        mildPastaIngredients[0].ingredients.some((i) =>
          i.name === "Chili Flakes"
        ),
        false,
  ...
  await t.step(
    ...
    async () => {
      ...
      assertAndLog(
        spicyPastaIngredients[0].ingredients.some((i) =>
          i.name === "Chili Flakes"
        ),
        true,
