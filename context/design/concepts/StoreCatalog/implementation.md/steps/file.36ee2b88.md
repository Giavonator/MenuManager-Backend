---
timestamp: 'Thu Oct 23 2025 17:54:31 GMT-0400 (Eastern Daylight Time)'
parent: '[[../20251023_175431.eea1e46e.md]]'
content_id: 36ee2b88ca5a567b336b2f542b32410a8ef370b46d40a9894d8d4d2176c7bb05
---
...
1. add addPurchaseOptionOrder that takes an AtomicOrder and assigns it to the PurchaseOption.
2. add addItemOrder that takes an SelectOrder and assigns it to the Item.
3. For action and query comments only include the **requires** and the **effects** in two lines next to each other.
