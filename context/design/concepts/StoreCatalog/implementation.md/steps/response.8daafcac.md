---
timestamp: 'Thu Oct 23 2025 17:43:02 GMT-0400 (Eastern Daylight Time)'
parent: '[[../20251023_174302.cd273616.md]]'
content_id: 8daafcac360a991e1ceb52f2883b767b7a72cecf0d0d351e1f0d3b1af496a804
---
...
type AtomicOrder = ID; // Renamed from Order, aligns with concept spec's 'AtomicOrder'
type SelectOrder = ID; // New generic parameter, aligns with concept spec's 'SelectOrder'

/**
 * a set of Item with
 *   a names Set of String
 *   a set of PurchaseOption // Note: This is an implicit relationship, not a direct field on ItemDoc
 *   a purchase SelectOrder
 *    a confirmed Bool // Implied by 'confirmItem' action in concept spec
 */
interface ItemDoc {
  _id: Item;
  names: string[];
  confirmed: boolean; // Retained as implied by 'confirmItem' action in the concept spec
