...
content_id: c5e25a82e12b1b569d29b942b7063c6d0a80dc4d7d032e6c55c412f82e61729f
---
...
1. PurchaseOption must have a confirmed Bool.
2. Both Item and Purchase must have their respective Select and Atomic Orders.
3. Delete addOrderToPurchaseOption that is not to be done in this concept.
4. \_getPurchaseOptionDetails -> must include confirmed within the query output.
5. \_getItemByDetails -> \_getItemNames Item DO NOT HAVE A CONFIRMED ANYMORE. Now this query will only output its names.
